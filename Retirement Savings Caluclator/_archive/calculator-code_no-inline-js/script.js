document.addEventListener("DOMContentLoaded", function () {
   ...
   savePdfButton.addEventListener("click", printResults);

   // Add event listener for annual savings input to calculate savings rate
   annualSavingsInput.addEventListener("input", calculateSavingsRate);
});
