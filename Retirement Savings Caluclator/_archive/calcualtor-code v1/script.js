...
function createRetirementChart(monthlyIncome, monthlyExpenses) {
   ...
   const incomeColor = rootStyles.getPropertyValue("--paletteColor1").trim();
   const expensesColor = rootStyles.getPropertyValue("--paletteColor3").trim();
         ...
         datasets: [
            {
               ...
               backgroundColor: [
                  incomeColor, // Use paletteColor1 for income
                  expensesColor, // Use paletteColor2 for expenses
               ],
